  ...
  return (
    ...
    <div className="flex flex-col min-h-[50vh] relative z-[5] overflow-hidden p-[2em] lg:flex-row">
      ...
      <div className="flex flex-col text-lg p-2 px-4 items-center leading-9">
        <h2 className="text-5xl text-red-600 mb-2 text-center lg:text-left">PPI-Australia (PPIA)</h2>
        ...
        <div className="flex flex-row w-full justify-evenly lg:justify-start">
          ...
          <a href="https://www.ppi-australia.org/kipi-2022/"
            className="w-2/5 bg-[white] flex justify-center no-underline text-[#ec2027] border-2 border-grey m-[0.5em] px-[0.5em] py-[1em] rounded-[1.75em] hover:text-[white] hover:bg-[#ec2027]">
            <span>KIPI 2022</span>
          </a>
        </div>
      </div>
