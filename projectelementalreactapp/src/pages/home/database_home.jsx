...
export const image_arr = [
    <img class="d-block mx-auto responsive-carousel img-fluid" src={dummy1} alt='missing' />,
    <img class="d-block mx-auto responsive-carousel img-fluid" src={dummy2} alt='missing' />,
    <img class="d-block mx-auto responsive-carousel img-fluid" src={dummy3} alt='missing' />
];
